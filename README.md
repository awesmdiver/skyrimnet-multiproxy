...
[SkyrimNet](https://github.com/MinLL/SkyrimNet-GamePlugin) gives Skyrim NPCs dynamic, AI-driven dialogue, but it needs an OpenAI-compatible endpoint to talk to. SkyrimNet MultiProxy is that bridge: a lightweight background tool running on your PC that receives SkyrimNet's requests and routes each one to the AI model you choose.

Pick whichever dialogue source fits your setup:
...
* **Eight AI providers:** Claude and ChatGPT (via CLI logins), OpenRouter, GLM (z.ai), Nano-GPT, OpenAI, Kilo Gateway, and Ollama. Mix and match—requests are routed automatically based on the model name you select.
...
* **Q: Do I need SkyrimNet installed for this to work?**
  > **Yes.** This tool is a proxy server designed specifically to serve dialogue requests generated by [SkyrimNet](https://github.com/MinLL/SkyrimNet-GamePlugin).
...
* **[MinLL/SkyrimNet-GamePlugin](https://github.com/MinLL/SkyrimNet-GamePlugin)** — The Skyrim plugin mod that makes AI-driven NPC dialogue possible.
